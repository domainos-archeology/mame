...
#ifndef MAME_MACHINE_APOLLO_DN300_KBD_H
#define MAME_MACHINE_APOLLO_DN300_KBD_H
...
// ======================> apollo_dn300_kbd_device

class apollo_dn300_kbd_device : public device_t, public device_serial_interface
{
public:
	// construction/destruction
	apollo_dn300_kbd_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
private:
	...
	public:
		beeper();
		void start(apollo_dn300_kbd_device *device);
		void reset();
		void off();
		void on();
	private:
		...
		apollo_dn300_kbd_device *m_device; // pointer back to our device
	...
	apollo_dn300_kbd_device *m_device; // pointer to myself (nasty: used for cpu_context)
...
DECLARE_DEVICE_TYPE(APOLLO_DN300_KBD, apollo_dn300_kbd_device)

#endif // MAME_MACHINE_APOLLO_DN300_KBD_H
