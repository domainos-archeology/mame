...
apollo_dn300_graphics::bt458::bt458(running_machine &running_machine)
{
	m_machine = &running_machine;
}

void apollo_dn300_graphics::bt458::start()
{
	MLOG1(("start apollo_dn300_graphics::bt458"));
}

void apollo_dn300_graphics::bt458::reset()
{
	MLOG1(("reset apollo_dn300_graphics::bt458"));
...
void apollo_dn300_graphics::bt458::write(uint8_t data, uint8_t c10)
{
...
uint8_t apollo_dn300_graphics::bt458::read(uint8_t c10)
{
	uint8_t data = 0xff;
...
uint32_t apollo_dn300_graphics::bt458::get_rgb(uint8_t index)
{
...
const char *apollo_dn300_graphics::cr_text(offs_t offset, uint8_t data, uint8_t rw)
{
...
void apollo_dn300_graphics::log_cr1(const char * text)
{
...
void apollo_dn300_graphics::increment_h_clock()
{
...
void apollo_dn300_graphics::increment_v_clock()
{
...
void apollo_dn300_graphics::increment_p_clock()
{
	if (m_n_planes == 1)
	{
...
void apollo_dn300_graphics::set_cr1(uint8_t data)
{
...
void apollo_dn300_graphics::set_cr3a(uint8_t data)
{
	m_cr3a = data;
	if ((data & 0x80) == 0)
	{
...
void apollo_dn300_graphics::set_cr3b(uint8_t data)
{
	m_cr3b = data;
	if ((data & 0x80) == 0)
	{
...
void apollo_dn300_graphics::set_lut_cr(uint8_t data)
{
...
uint8_t apollo_dn300_graphics::apollo_mcr_r(offs_t offset)
{
	uint8_t data;
	switch (offset & 0x407)
	{
...
void apollo_dn300_graphics::reg_w(offs_t offset, uint8_t data)
{
	...
	MLOG2(("writing display reg %02x (%s) with %02x",
			offset, graphics_reg_write_names[(offset/2) & 8], data));

	// XXX actually do the write
}

uint8_t apollo_dn300_graphics::reg_r(offs_t offset)
{
	...
	// XXX actually do the read
	MLOG2(("reading display reg %02x (%s)",
			offset, graphics_reg_read_names[(offset/2) & 8]));

	return 0;
}

void apollo_dn300_graphics::apollo_mcr_w(offs_t offset, uint8_t data)
{
...
void apollo_dn300_graphics::set_status_rmw()
{
...
uint16_t apollo_dn300_graphics::rop(uint16_t dest_data, uint16_t src_data, uint8_t plane)
{
...
void apollo_dn300_graphics::set_source_data(uint32_t offset)
{
...
uint32_t apollo_dn300_graphics::get_source_data(uint8_t plane)
{
	uint32_t src_data;
...
void apollo_dn300_graphics::blt(uint32_t dest_addr, uint16_t mem_mask)
{
...
uint16_t apollo_dn300_graphics::apollo_mem_r(offs_t offset, uint16_t mem_mask)
{
	uint16_t data;
	uint32_t src_addr;
...
void apollo_dn300_graphics::apollo_mem_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	uint32_t dest_addr;
	uint32_t src_addr;
...
uint8_t apollo_dn300_graphics::apollo_ccr_r(offs_t offset)
{
	uint8_t data;
	...
	else if (m_n_planes == 8)
	{
		...
		case 0x401:
			...
			{
				MLOG1(("apollo_dn300_graphics::apollo_ccr_r: reading LUT data register with unexpected RW = 0 in LUT Control register"));
				data = m_lut_data;
			}
			...
			{
				MLOG1(("apollo_dn300_graphics::apollo_ccr_r: reading LUT data register with unexpected CS in LUT Control register"));
				data = m_lut_data;
			}
			break;
		case 0x403:
...
uint8_t apollo_dn300_graphics::get_pixel(uint32_t offset, uint16_t mask)
{
	uint8_t data = 0;
...
uint8_t apollo_dn300_graphics::c4p_read_adc(uint8_t data)
{
	uint8_t value = 0;
...
uint8_t apollo_dn300_graphics::c8p_read_adc(uint8_t data)
{
	uint8_t value = 0;
...
void apollo_dn300_graphics::apollo_ccr_w(offs_t offset, uint8_t data)
{
	...
	else if (m_n_planes == 8)
	{
		...
		case 0x401:
			...
			{
				MLOG1(("apollo_dn300_graphics::apollo_ccr_w: writing LUT data register with RW = 1 in LUT Control register"));
			}
			...
			{
				MLOG1(("apollo_dn300_graphics::apollo_ccr_w: writing LUT data register with unexpected CS in LUT Control register"));
			}
			break;
		case 0x403:
			// LUT control register
...
uint16_t apollo_dn300_graphics::apollo_cgm_r(offs_t offset, uint16_t mem_mask)
{
	if (!is_mono())
	{
...
void apollo_dn300_graphics::apollo_cgm_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (!is_mono())
	{
...
uint16_t apollo_dn300_graphics::apollo_mgm_r(offs_t offset, uint16_t mem_mask)
{
	if (is_mono())
	{
		return apollo_mem_r(offset, mem_mask);
...
void apollo_dn300_graphics::apollo_mgm_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (is_mono())
	{
		apollo_mem_w(offset, data, mem_mask);
